...
console.log(wantToVisit('NEMO Science Museum', 'Amsterdam') === true); // fix
console.log(wantToVisit('National Museum of Modern Art', 'Paris') === false);
console.log(wantToVisit('Andy Warhol Museum of Modern Art', 'Medzilaborce') === true); // fix
console.log(wantToVisit('Moco: Modern Contemporary Art', 'Amsterdam') === true); // fix
